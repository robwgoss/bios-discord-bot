...
`T_FLIP (USER_ID INTEGER PRIMARY KEY, HEADS INTEGER, TAILS INTEGER, DTE_LAST_FLIP INTEGER)`</br></br>
`T_QUEUE (ID INTEGER PRIMARY KEY AUTOINCREMENT, GUILD_ID TEXT NOT NULL, URL TEXT NOT NULL, DTE_ADDED INTEGER NOT NULL, TIME_ADDED INTEGER NOT NULL)`